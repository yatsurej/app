            ...
            <div class="carousel-inner">
                <?php
                    $query = "SELECT e.*, m.locationTo, SUM(m.actualCount) as totalActualCount
                            ...
                            WHERE m.locationTo LIKE '%$currentGalleryName%'
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p><strong>Model:</strong> <?php echo $exhibitModel; ?></p>
                                    <p><strong>Information:</strong> <?php echo $exhibitInformation; ?></p>
                                    <p><strong>Location:</strong> <?php echo $exhibitLocation; ?></p>
                                    ...
                                    <?php } else{ ?>
                                        <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#sendRatingFeedback<?php echo $exhibitID; ?>">Rate</button>
                                    <?php
                                        }
                                    ?>
                                    <div class="modal fade" id="sendRatingFeedback<?php echo $exhibitID; ?>" tabindex="-1" aria-labelledby="sendRatingFeedbackLabel"aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    <form action="functions.php" method="post">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea type="text" class="form-control" rows="5" id="userFeedback"
                                                                    placeholder="Write down your feedback (optional)" name="exhibitInformation"
                                                                    required></textarea>
                                                        </div>
                                                        <div class="text-end">
